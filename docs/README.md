...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-07 19:56:44 UTC<br>状态：成功</p>
</section>
...
<p>精读：《ARMOR: Manifold-Oriented Training for Adversarially Robust Aerial Object Detection under Data Scarcity》（9.0/10）, 《Jailbreaking Text-to-Image Models Through Cracks: Navigating Heterogeneous Safety Filters via Multi-Agent Debate》（9.0/10）</p>
<p>速读：《Rethinking Indirect Prompt Injection as a Test-Time Search Problem》（8.0/10）, 《SiLR: Structure-Preserving Admission and Process Reward for LLM Tool Agents》（8.0/10）, 《Refuse without Refusal: A Structural Analysis of Safety-Tuning Responses for Reducing False Refusals in Language Models》（8.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="ARMOR: Manifold-Oriented Training for Adversarially Robust Aerial Object Detection under Data Scarcity">ARMOR: Manifold-Oriented Training for Adversarially Robust Aerial Object Detection under Data Scarcity</span></li><li><span class="dpr-home-dashboard-paper-title" title="Jailbreaking Text-to-Image Models Through Cracks: Navigating Heterogeneous Safety Filters via Multi-Agent Debate">Jailbreaking Text-to-Image Models Through Cracks: Navigating Heterogeneous Safety Filters via Multi-Agent Debate</span></li><li><span class="dpr-home-dashboard-paper-title" title="Representational alignment yields generalizable safety in language models">Representational alignment yields generalizable safety in language models</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">agsec <strong>5</strong></span><span class="dpr-home-dashboard-tag">vuldet <strong>2</strong></span></div>
</section>
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Rethinking Indirect Prompt Injection as a Test-Time Search Problem">Rethinking Indirect Prompt Injection as a Test-Time Search Problem</span></li><li><span class="dpr-home-dashboard-paper-title" title="SiLR: Structure-Preserving Admission and Process Reward for LLM Tool Agents">SiLR: Structure-Preserving Admission and Process Reward for LLM Tool Agents</span></li><li><span class="dpr-home-dashboard-paper-title" title="Refuse without Refusal: A Structural Analysis of Safety-Tuning Responses for Reducing False Refusals in Language Models">Refuse without Refusal: A Structural Analysis of Safety-Tuning Responses for Reducing False Refusals in Language Models</span></li></ul>
  </div>
