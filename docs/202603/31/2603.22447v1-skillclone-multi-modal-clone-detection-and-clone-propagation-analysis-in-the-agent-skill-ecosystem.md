...
tldr: 针对智能体技能生态中多模态内容（YAML、自然语言、代码）缺乏克隆检测机制导致的系统性风险，本文提出了首个多模态克隆检测方法 SkillClone。该方法通过逻辑回归融合多通道特征，在 SkillClone-Bench 基准测试中表现优异。对2万个技能的实证分析揭示了严重的克隆现象，发现生态系统存在3.5倍的冗余，为技能维护和安全提供了重要见解。
selection_source: fresh_fetch
motivation: 智能体技能由多模态内容组成且数量激增，但现有单模态检测器无法处理其复杂结构，导致漏洞传播和维护困难。
method: 提出 SkillClone 方法，利用逻辑回归融合 YAML 属性、自然语言指令和嵌入代码的相似度，实现多模态克隆检测与解释性分类。
result: "SkillClone 达到 0.939 的 F1 分数，分析显示 75% 的技能存在克隆关系，且 41% 的克隆技能已被更优版本取代。"
conclusion: 该研究首次实现了智能体技能的多模态克隆检测，揭示了生态系统的高度冗余性，对提升智能体技能的质量和安全性具有重要意义。
---
