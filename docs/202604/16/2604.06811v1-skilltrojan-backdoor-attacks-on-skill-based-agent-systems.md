...
tags: ["query:agsec"]
score: 7.0
evidence: 通过恶意技能实现对基于技能的智能体系统进行后门攻击
tldr: 本文提出SkillTrojan，一种针对基于技能的智能体系统的后门攻击。该攻击通过在看似正常的技能实现中嵌入恶意逻辑，将加密负载拆分至多次技能调用中，并由特定触发器激活。研究展示了如何自动化合成后门技能，并发布了包含3000多个样本的数据集。实验表明，该攻击在保持高正常任务性能的同时，能实现极高的攻击成功率，揭示了智能体架构中的关键安全盲点。
selection_source: fresh_fetch
motivation: 现有的智能体安全研究主要集中在模型参数和训练数据，忽略了技能模块化组合过程中技能实现本身带来的安全风险。
method: 通过在多个技能调用中拆分并隐藏加密的恶意负载，并利用自动化合成技术将后门植入技能模板中。
result: "在EHR SQL任务测试中，SkillTrojan在保持89.3%正常准确率的情况下，攻击成功率高达97.2%。"
conclusion: 技能级后门攻击具有极强的隐蔽性和有效性，迫切需要开发能够对技能组合和执行过程进行安全推理的防御机制。
---
